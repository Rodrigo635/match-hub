        ...
        <main className="page-termos-de-uso">
            <section className="py-5 text-white">
                <div className="container">
                    ...
                    <div className="border-bottom border-muted mb-4"></div>
                    ...
                    <p className="mb-4">
                        ...
                        <a href="/politicas-de-privacidade" className="text-azul ms-1">
                    ...
                    <p className="mb-4">
                        ...
                        conosco pelo e-mail:
                        <a href="mailto:contato@seusite.com.br" className="text-azul ms-1">
                            matchhub@gmail.com
                        </a>
                        .
                    </p>

                    <h1 className="mb-4 mt-5">Condições</h1>
                    ...
                    <p className="mb-2">Ao utilizar o site, você concorda em não:</p>
                    <ul className="mb-4">
