...
export default function ChampionshipDetailsPage() {
  ...
  const getMatchesByStatus = (status) => {
    ...
    return championshipData.matches.filter(match => {
          ...
          <div className="row align-items-center">
            ...
            <div className="col-md-9">
              ...
              {championshipData.description && (
                <p className="lead text-light mb-4">{championshipData.description}</p>
              )}
              ...
              <div className="row text-white">
                ...
                <div className="">
                  ...
                  <span className="fw-bold">Partidas:</span> {championshipData.totalMatches || 0}
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="row g-4">
              ...
              {teams.length > 0 ? (
                teams.map((team) => (
                  <div key={team.id} className="col-12 col-sm-6 col-md-4 col-lg-3">
                    <div
                      ...
                      tabIndex={0}
                      onClick={() => {
                        try { localStorage.setItem('selectedTeam', JSON.stringify(team.id)); } catch (e) { }
                ...
                <div className="col-12 text-center py-5">
                  <p className="text-white">Nenhum time cadastrado neste campeonato.</p>
                </div>
              )}
            </div>
          )}
            ...
            <div>
              ...
              <div className="row g-4">
                {upcomingMatches.length > 0 ? (
                        ...
                        <div className="card-body p-4">
                          <div className="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <div className="text-center">
                              ...
                              <small className="d-block mt-2">{match.matchTeams[1]?.team?.name}</small>
                            </div>
                          </div>
                  ...
                  <div className="col-12 text-center py-5">
                    <p className="text-white">Nenhuma partida futura agendada.</p>
                  </div>
                )}
              </div>
            </div>
            ...
            <div>
              ...
              <div className="row g-4">
                {pastMatches.length > 0 ? (
                  ...
                  <div className="col-12 text-center py-5">
                    <p className="text-white">Nenhuma partida passada encontrada.</p>
                  </div>
                )}
              </div>
            </div>
