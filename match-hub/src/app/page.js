    ...
    <main className="mt-3 mb-5">
      <div className="container d-flex align-items-center justify-content-center">
        <div className="container-card">
          <label id="c1" htmlFor="c1" className="cards card-width">
          ...
          <label htmlFor="c2" id="c2" className="cards">
            <div className="conteudo-card">
          ...
          <label htmlFor="c3" id="c3" className="cards">
            <div className="conteudo-card">
          ...
          <label htmlFor="c4" id="c4" className="cards">
            <div className="conteudo-card">
    ...
    <section className="lista-funcoes-bg">
      <div className="container">
        <div className="row my-5">
          ...
          >
            <h1 className="text-white fw-bold">Construído para você!</h1>
