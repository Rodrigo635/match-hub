...
export default function Notificacoes({ user }) {
  ...
  return (
    ...
    {!loading && notifs.length === 0 && (
      <div className="empty-state p-4 rounded-3 text-center" style={{ backgroundColor: "var(--cor-bgEscuro)", border: "none" }}>
      ...
      <div className="row g-3">
        {notifs.map(n => (
          <div key={n.id} className="col-12 ">
            <div className="notification-card shadow d-flex align-items-center p-3 rounded-3" style={{ backgroundColor: "var(--cor-bgEscuro)", border: "none" }}>
